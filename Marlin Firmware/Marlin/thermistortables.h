...
#if (THERMISTORHEATER_0 == 60) || (THERMISTORHEATER_1 == 60) || (THERMISTORHEATER_2 == 60) || (THERMISTORBED == 60) // Alirubber Heated Bed

// Geeetech Thermistor Table (used for RioRand 100k)
